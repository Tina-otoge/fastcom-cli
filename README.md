...
```
fastcom [-h] [-q] [-i ITERATIONS] [-s SERVERS] [-j] [-t TRIM] [-v]
...
options:
  ...
  -s SERVERS, --servers SERVERS
                        Controls the number of servers to test against during each loop
                        (default: 5)
  -j, --json            Outputs a JSON formatted summary (implies --quiet) (default: False)
  -t TRIM, --trim TRIM  Controls the percentage of results to trim from the top and bottom of
                        the results for the "Mean (trimmed)" value (default: 10)
